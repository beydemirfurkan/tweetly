...
const createExtraction = z.object({
  type: extractionType,
...
export const TOOL_SCHEMAS = {
  ...
  get_extraction: getExtraction,
  list_extractions: listExtractions,
